...
class PaymentInstrumentDetailTest {
  ...
  fun `can instantiate a PaymentInstrumentDetail from valid bin, maskedPan and expiryDate`() {
    ...
    val paymentInstrumentDetail = PaymentInstrumentDetail(VALID_BIN, VALID_MASKED_PAN, VALID_EXPIRY_DATE)
  ...
  fun `can't instantiate a PaymentInstrumentDetail from valid bin, maskedPan and invalid expiryDate`() {
    ...
    assertThrows<IllegalArgumentException> { PaymentInstrumentDetail(VALID_BIN, VALID_MASKED_PAN, INVALID_EXPIRY_DATE) }
  }
  ...
  fun `can't instantiate a PaymentInstrumentDetail from valid bin, expiryDate and invalid maskedPan`() {
    ...
    assertThrows<IllegalArgumentException> { PaymentInstrumentDetail(VALID_BIN, INVALID_MASKED_PAN, VALID_EXPIRY_DATE) }
  }
  ...
  fun `can't instantiate a PaymentInstrumentDetail from valid maskedPan, expiryDate and invalid bin`() {
    ...
    assertThrows<IllegalArgumentException> { PaymentInstrumentDetail(INVALID_BIN, VALID_MASKED_PAN, VALID_EXPIRY_DATE) }
  }
}
