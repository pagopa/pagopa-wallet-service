                        ...
                        CreateHostedOrderRequest()
                            ...
                            .order(
                                Order()
                                    ...
                                    .currency(
                                        WalletService.CREATE_HOSTED_ORDER_REQUEST_CURRENCY_EUR
                                    )
                                ...
                                PaymentSession()
                                    ...
                                    .recurrence(
                                        RecurringSettings()
                                            ...
                                            .contractId(
                                                WalletService
                                                    .CREATE_HOSTED_ORDER_REQUEST_CONTRACT_ID
                                            )
                                            .contractType(RecurringContractType.CIT)
                                    )
                                    .amount(WalletService.CREATE_HOSTED_ORDER_REQUEST_VERIFY_AMOUNT)
                                    .language(
                                        WalletService.CREATE_HOSTED_ORDER_REQUEST_LANGUAGE_ITA
                                    )
        ...
        fun `should find wallet document`() {
            ...
            mockStatic(UUID::class.java, Mockito.CALLS_REAL_METHODS).use {
                ...
                mockStatic(Instant::class.java, Mockito.CALLS_REAL_METHODS).use {
                    ...
                    val walletInfoDto =
                        WalletInfoDto()
                            .walletId(UUID.fromString(wallet.walletId))
