...
class DomainEventDispatcherServiceTest {
    ...
    @Test
    fun `should not dispatch WalletCreatedEvent when WalletAdded domain event is generated by migration`() {
        val walletCreatedLoggingEvent =
            WalletAddedEvent(walletId = UUID.randomUUID().toString(), true)
        ...
        verify(walletQueueClient, times(0)).sendWalletCreatedEvent(any(), any(), any())
    }
