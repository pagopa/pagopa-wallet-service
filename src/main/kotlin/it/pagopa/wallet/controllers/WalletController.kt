...
class WalletController(
    ...
    override fun patchWallet(walletId: UUID?, walletStatusPatchRequestDto: Mono<WalletStatusPatchRequestDto>?, exchange: ServerWebExchange?): Mono<ResponseEntity<Void>> {
