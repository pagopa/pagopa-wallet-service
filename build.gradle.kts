...
tasks.register("ecommercePaymentMethod", GenerateTask::class.java) {
    ...
    generatorName.set("java")
    remoteInputSpec.set(
        "https://raw.githubusercontent.com/pagopa/pagopa-infra/CHK-4451-add-payment-methods-handler-api/src/domains/ecommerce-app/api/ecommerce-payment-methods-service/v1/_openapi.json.tpl"
    )
    outputDir.set("${layout.buildDirectory.get()}/generated")
...
tasks.register<GenerateTask>("ecommercePaymentMethodV2") {
    ...
    generatorName.set("java")
    remoteInputSpec.set(
        "https://raw.githubusercontent.com/pagopa/pagopa-infra/CHK-4451-add-payment-methods-handler-api/src/domains/ecommerce-app/api/ecommerce-payment-methods-service/v2/_openapi.json.tpl"
    )
    outputDir.set("${layout.buildDirectory.get()}/generated")
